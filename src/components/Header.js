...
const socials = [
  {
    icon: faEnvelope,
    url: "mailto: bruno.fernando.s@outlook.com",
  },
  {
    icon: faGithub,
    url: "https://github.com/bflud",
  },
  {
    icon: faLinkedin,
    url: "https://www.linkedin.com/in/bfsi/",
  },
  {
    icon: faMedium,
    url: "https://medium.com/@thenextludouz",
  },
  {
    icon: faStackOverflow,
    url: "https://stackoverflow.com/users/22899134/bruno-fernando",
  },
];
        ...
        >
          ...
          <nav>
            <HStack spacing={8}>
              ...
              <a href="#projects" onClick={handleClick("projects")}>Projetos</a>
              <a href="#contact" onClick={handleClick("contactme")}>Contato</a>
